      ...
      <React.Fragment>
        ...
        {firstLink.pendingTypes &&
          <tr>
            ...
            <td>
              {texp.l(
                `The following type(s) will be automatically selected
                 when submitting: {types}`,
                {
                  types: firstLink.pendingTypes
                    .map(type => linkedEntities.link_type[type].link_phrase)
                    .join(', '),
                },
              )}
            </td>
